...
class TransactionType extends $pb.ProtobufEnum {
  static const TransactionType deposit = TransactionType._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'deposit');
  static const TransactionType withdrawal = TransactionType._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'withdrawal');
